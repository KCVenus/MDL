...
INSERT INTO `doctrine_migration_versions` VALUES ('DoctrineMigrations\\Version20240315130732','2024-03-20 08:08:16',1492);
...
INSERT INTO `proposer` VALUES (1,1,1,95),(3,2,1,70),(4,2,2,80),(5,1,2,105);
...
CREATE TABLE `user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `numlicencie` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2024-04-19 17:01:42
